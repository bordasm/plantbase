...
> **Projekt-független** coding conventions, bármely TypeScript projektre. (A plantbase-specifikus döntések: `architektura.md`; az agent SQL-szabályai: `system-prompt.md`.) Ezt is 1:1 átadjuk a Claude Code-nak.
